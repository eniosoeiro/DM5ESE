> Visual 0.20.0 aplicado: nova tela Início, cinco destinos de navegação, marca vetorial, atalhos e Ajustes reorganizados. Detalhes e validações: `../docs/android-v0.20.0-design.md`. Logos editáveis: `branding/`.
...
Versão atual: **0.20.0**, com envio de capturas para IntegraNR / Med.Online / Medição de espessuras.
APK: `../artifacts/android-usb/ES-Medicao-v0.20.0.apk`. Instale como atualização para preservar as capturas.
